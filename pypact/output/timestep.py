...
class TimeStep(JSONSerializable):
    ...
    def fispact_deserialize(self, filerecord, interval):
        ...
        if substring:
            ...
            self.alpha_heat = get_value(
                starttag="TOTAL ALPHA HEAT PRODUCTION", endtag="kW"
            )
            self.beta_heat = get_value(
                starttag="TOTAL BETA  HEAT PRODUCTION", endtag="kW"
            )
            self.gamma_heat = get_value(
                starttag="TOTAL GAMMA HEAT PRODUCTION", endtag="kW"
            )
            ...
            self.total_mass = get_value(
                starttag="0  TOTAL MASS OF MATERIAL", endtag="kg"
            )

            self.number_of_fissions = get_value(
                starttag="NUMBER OF FISSIONS", endtag="BURN-UP"
            )
            ...
            self.alpha_activity = get_value(
                starttag="ALPHA BECQUERELS =", endtag="BETA"
            )
